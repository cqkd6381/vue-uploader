<template>
  <div class="uploader-file" :status="status">
    <slot
      ...
      <div class="progress" :style="progressStyle2">
      </div>
    </slot>
  </div>
</template>
...
<style>
  .uploader-file .progress{height:2px;position: absolute;bottom:-20px;background-color:rgba(0,106,223,.2);box-shadow: none; left: 0;border-radius: 0;}
  .uploader-file:last-child{border-bottom: none;}
  .uploader-file .item-icon{width: 30px;height: 30px;position: absolute;left: 20px;}
  .uploader-file .item-icon .icon{width: 30px;height: 30px;}
  .uploader-file .item-info{padding-left: 40px;font-size: 12px;}
  .uploader-file .item-info p{color: #999; margin-top: 5px;}
  .uploader-file .item-status{width: 30px;height: 30px;text-align: center;line-height: 30px;position: absolute;right: 20px;top: 20px;}
  .uploader-file .item-status .icon-status-succ{color: #00c15c;}
  .uploader-file .item-status .icon-status-fail{color: #fc3f3f;}
</style>
